        ...
        {visiblePages.map((page, index) => {
          ...
          return (
            <button
              ...
              disabled={isLoading}
              className={`px-3 py-2 text-sm font-medium border rounded-md transition-colors duration-200 disabled:cursor-not-allowed ${
                isActive
                  ? 'bg-blue-600 text-white border-blue-600 dark:bg-blue-500 dark:border-blue-500'
                  : 'text-gray-700 bg-white border-gray-300 hover:bg-gray-50 hover:text-gray-900 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white'
              }`}
            >
              {pageNum}
            </button>

...
import { useGetPopularTVShowsQuery } from "../../features/movies/moviesSlice";
...
export default function PopularTVShowsPage() {
  ...
  const { data, error, isLoading, refetch } = useGetPopularTVShowsQuery({ page: currentPage });
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {error && (
          <ErrorMessage 
            message="Failed to load popular TV shows. Please try again."
            onRetry={refetch}
          />
        )}

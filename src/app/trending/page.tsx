...
import { useGetPopularMoviesQuery } from "../../features/movies/moviesSlice"; // Using popular as trending
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            The hottest movies trending this week
          </p>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {error && (
          <ErrorMessage 
            message="Failed to load trending movies. Please try again."
            onRetry={refetch}
          />
        )}
            ...
            {data.total_pages > 1 && (
              <>
                ...
                <div className="text-center mt-4 text-sm text-gray-600 dark:text-gray-400">
                  Showing page {currentPage} of {Math.min(data.total_pages, 500)} ({data.total_results.toLocaleString()} total movies)
                </div>
              </>
            )}
          </>
